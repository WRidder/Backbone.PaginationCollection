...
module.exports = function(release) {
  return {
    entry: './src/Backbone.PaginationCollection.js',

    output: {
      filename: (release) ? 'lib/Backbone.PaginationCollection.min.js' : 'lib/Backbone.PaginationCollection.js',

      // Library settings
      library: "Backbone.PaginationCollection",
      libraryTarget: "umd"
    },
		externals: {
